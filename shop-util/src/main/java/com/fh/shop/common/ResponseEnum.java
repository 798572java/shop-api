...
ResponseEnum {
    ...
    /*会员*/
    MEMBER_PHONE_ISNULL(6000,"手机号不能为空，请重新填写手机号"),
    MEMBER_PASSWORD_ISERROR(6002,"密码不一致，请两次密码保持一致"),
    MEMBER_CODE_ISERROR(6003,"验证码不一致，请输入正确验证码"),
    MEMBER_CODE_IS_NOT(6030,"验证码过期，请在有效期内填写验证码"),
    MEMBER_URL_NOT_ERROR(6040,"链接出错"),
    MEMBER_CODE_IS_NULL(6004,"信息不能为空"),
    MEMBER_CODE_IS_NO_YES(6100,"验证码不一致"),
    MEMBER_EMAIL_IS_NOT(6101,"邮箱不存在，请重新填写邮箱"),
    MEMBER_IS_THIS(6004,"用户已存在，请重新填写用户"),
    MEMBER_IS_NULL(6000,"信息不能为空"),

    //订单
    ORDER_STOCK_IS_DEFICIENCY(6500,"库存不足"),
    ORDER_CART_IS_NULL(6501,"购物车订单为空，请添加商品"),
    ORDER_RECIPIENT_IS_NULL(6502,"订单收件人为空，请添加收件人信息"),
    ORDER_STATUS_IS_ERROR(6503,"订单状态错误"),
    ...
    //结算
    RECIPIENTS_INFO_IS_NULL(5500,"信息为空"),
    RECIPIENTS_PEOPLE_INFO_IS_NULL(5501,"信息人为空"),

    //支付
    PAY_ORDER_ID_IS_ERROR(5800,"支付订单有误"),
    PAY_ORDER_STATUS_IS_ERROR(5801,"支付状态有误"),
    PAY_ORDER_STATUS_IS_SUCCESS(5802,"已是支付成功状态"),
    ...
    MEMBER_REG_EMAIL_MEMBERNAME_IS_YES(6014,"邮箱与用户不匹配"),
